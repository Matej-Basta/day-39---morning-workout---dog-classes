...
class Chihuahua extends Dog
{
    public function __construct($name, $natural_enemies = [])
    {
        $this->position = "standing";
        $this->name = $name;
        $this->natural_enemies = array_merge(["curela deville"], $natural_enemies);
    }

    public function sit()
    {
        $this->position = "still standing"; 
        return "Sit, ".$this->name."!";
    }
}
...
<?php $second_dog = new Chihuahua("Gidget", ["tacos"]); ?>
 
<p>Chihuahua's name is <?= $second_dog->readDogTag() ?></p>
<p>Chihuahua goes <?= $second_dog->barkAt("Tacos") ?> at <i>Tacos</i></p>
